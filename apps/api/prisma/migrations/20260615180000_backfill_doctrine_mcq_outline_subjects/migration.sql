-- Backfill study_8 subject assignments for approved+public doctrine_extract / mcq_question /
-- subject_outline artifacts that have none, inheriting from the source legal_document.
...
WHERE da.derivative_type IN ('doctrine_extract', 'mcq_question', 'subject_outline')
