 ...
 *
 * The copy is client-owned, matching how the reader's chat sheet writes its own
 * abstention string rather than echoing the server
 * (`features/ai-answers/components/document-chat-sheet.tsx:204-213`).
 */
