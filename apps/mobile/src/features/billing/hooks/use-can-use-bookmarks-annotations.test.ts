...
import { useCanUseBookmarksAnnotations } from './use-can-use-bookmarks-annotations';
...
describe('useCanUseBookmarksAnnotations', () => {
  ...
  it('does not lock on non-404 errors (fail-open to the 403 fallback)', async () => {
  ...
  it('does not lock active edu plan orgs', async () => {
