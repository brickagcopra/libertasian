...
export { GatedNotice } from './gated-notice';
export { Unavailable } from './unavailable';

export type MobileRenderer = (props: { data: DerivativeDetail }) => ReactElement;

// PR B1: 6 dedicated renderers. The remaining 5 types (essay_model_answer,
// suggested_bar_answer, sample_pleading, sample_contract, one_page_summary)
// fall through to GenericRenderer and will be replaced in PR B2.
export const RENDERER_BY_TYPE: Record<DerivativeType, MobileRenderer> = {
