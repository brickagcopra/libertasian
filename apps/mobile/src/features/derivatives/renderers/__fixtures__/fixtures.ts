...
export const MCQ_CONTENT = {
  ...
  options: [
    ...
    { label: 'C', text: 'Stare decisis', isCorrect: false },
    { label: 'D', text: 'Ejusdem generis', isCorrect: false },
  ],
...
export const ESSAY_CONTENT = {
  ...
  modelAnswer: {
    outlineSections: [
      ...
      { heading: 'Law', paragraphs: ['Art. III, Sec. 2 and Sec. 3(2).'] },
    ],
  },
  rubric: {
    totalPoints: 100,
...
export const OUTLINE_CONTENT = {
  ...
  sections: [
    ...
    { heading: 'Right to Counsel', paragraphs: ['Coverage of Art. III, Sec. 12.'] },
  ],
};
