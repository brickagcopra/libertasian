        ...
        options={{
          ...
          headerRight: () => (
            ...
            >
              ...
              >
                {generateTimeline.isPending ? 'Generating...' : 'Generate'}
              </Text>
            </TouchableOpacity>
          ),
        }}
        ...
        >
          ...
          <View style={styles.field}>
            ...
            <TextInput
              ...
              placeholder="e.g., History of Agrarian Reform Cases"
              placeholderTextColor="#9ca3af"
              editable={!generateTimeline.isPending}
            />
          </View>
          ...
          <View style={styles.field}>
            <Text style={styles.label}>
              Search Documents ({selectedDocs.length}/10)
            </Text>
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoText}>
              Select legal documents to generate a chronological timeline of key
              events. The AI will extract dates, filings, decisions, and other
              events. Generation may take up to 60 seconds.
            </Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
