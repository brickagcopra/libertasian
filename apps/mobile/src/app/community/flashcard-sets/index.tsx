...
export default function MarketplaceFlashcardSetsScreen() {
  const [search, setSearch] = useState('');
  const navigate = useTabBarNav();
  const clearance = useTabBarClearance();
  const [sortBy, setSortBy] = useState<MarketplaceSortBy>('top_rated');

  const { data, isLoading, isFetching, refetch } = useMarketplaceFlashcardSets({
    sortBy,
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'Flashcard Sets' }} />
            ...
            isLoading ? (
              ...
              <View style={styles.emptyBox}>
                ...
                <Text style={styles.emptyText}>
                  No flashcard sets found. Try adjusting your search.
                </Text>
              </View>
            )
          }
