    ...
    <div className="relative w-full max-w-md">
      ...
      <div className="rounded-2xl border border-warm-ink/10 bg-warm-surface p-8 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
        <div className="mb-6 flex flex-col items-center text-center">
          <Wordmark size={36} />
          <p className="mt-3 text-sm text-warm-ink-mid">Sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid gap-2">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-warm-ink-mid hover:text-warm-ink text-sm"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            {mfaRequired && (
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  {...register('mfaCode')}
                />
                <p className="text-warm-ink-mid text-xs">
          ...
          <p className="text-center text-sm text-warm-ink-mid">
            ...
            <Link href={ROUTES.REGISTER} className="font-medium text-warm-ink hover:underline">
              Create one
            </Link>
          </p>
        </form>
