...
export default function MarketplaceReviewerPacksPage() {
  ...
  const { data, isLoading, error } = useMarketplaceReviewerPacks({
    sortBy,
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Browse curated reviewer packs for Philippine bar exam preparation.
        </p>
      </div>
      ...
      {!isLoading && items.length === 0 && (
        <p className="py-12 text-center text-sm text-muted-foreground">
          No reviewer packs found. Try adjusting your filters.
        </p>
      )}
