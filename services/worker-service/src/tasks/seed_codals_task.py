...
SEED_CODALS: list[CodalSeed] = [
    ...
    # ------------------------------------------------------------------
    # Rules of Court — split from the single ``rc.html`` TOC entry into
    # one CodalSeed per topic sub-page. The TOC index serves only
    # navigation markup with no rule text, so it was never usefully
    # importable; the text-line section parser (PR #185) sections each
    # sub-page by ``RULE N`` markers. The TOC's ``jbc_009_2000.html`` is
    # the JBC rule (not a Rule of Court) and is intentionally excluded.
    CodalSeed(
        title="Rules of Court — Civil Procedure (Rules 1-71)",
        short_title="Civil Procedure (Rules 1-71)",
        url="https://lawphil.net/courts/rules/rc_1-71_civil.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rules 1-71",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Special Proceedings (Rules 72-109)",
        short_title="Special Proceedings (Rules 72-109)",
        url="https://lawphil.net/courts/rules/rc_72-109_proceedings.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rules 72-109",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Criminal Procedure (Rules 110-127)",
        short_title="Criminal Procedure (Rules 110-127)",
        url="https://lawphil.net/courts/rules/rc_110-127_2000.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rules 110-127",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Evidence (Rules 128-134)",
        short_title="Evidence (Rules 128-134)",
        url="https://lawphil.net/courts/rules/rc_128-134_evidence.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rules 128-134",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Rule 135",
        short_title="Rule 135",
        url="https://lawphil.net/courts/rules/rc_135_judicial.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rule 135",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Rule 136",
        short_title="Rule 136",
        url="https://lawphil.net/courts/rules/rc_136_staff.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rule 136",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Rule 137",
        short_title="Rule 137",
        url="https://lawphil.net/courts/rules/rc_137_judicial.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rule 137",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Rule 138 (Attorneys and Admission to the Bar)",
        short_title="Rule 138 (Attorneys)",
        url="https://lawphil.net/courts/rules/rc_138_bar.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rule 138",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Rule 139-A",
        short_title="Rule 139-A",
        url="https://lawphil.net/courts/rules/rc_139-a_1973.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rule 139-A",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Rule 139-B",
        short_title="Rule 139-B",
        url="https://lawphil.net/courts/rules/rc_139-b_1988.html",
        document_type="rules_of_court",
        citation_text="Rules of Court, Rule 139-B",
        primary_subject="remedial_law",
    ),
    CodalSeed(
        title="Rules of Court — Rule 141 (Legal Fees)",
        short_title="Rule 141 (Legal Fees)",
        url="https://lawphil.net/courts/rules/rc_141_legal.html",
        document_type="rules_of_court",
