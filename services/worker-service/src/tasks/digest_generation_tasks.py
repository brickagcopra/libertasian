...
def generate_case_digest(
    ...
    try:
        ...
        # rag-service /digests/generate started returning token counts in
        # PR #76 (DigestGenerationResponse.tokens_in/tokens_out). Pull them
        # so model_runs + the downstream job-status update populate
