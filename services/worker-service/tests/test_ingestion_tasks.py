...
class TestChainPostIngestion:
    ...
    def test_dispatches_follow_up_tasks(
        ...
        with patch("src.tasks.ingestion_tasks.validate_and_publish") as mock_val, \
             patch("src.tasks.citation_tasks.extract_citations_for_document") as mock_cit_extract, \
            ...
            mock_cit_extract.delay = MagicMock()
        ...
        mock_cit_extract.delay.assert_called_once_with(legal_document_id=document_id)
